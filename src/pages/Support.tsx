...
export default function Support() {
  // Replace this with your actual WhatsApp support number, including country code (e.g. 15551234567)
  const whatsappNumber = "1234567890";
  const message = "Hi! I need some help with the Master Dashboard.";
  ...
  return (
    <>
      <PageMeta
        ...
        description="Get help and support for your dashboard."
      />
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03] lg:p-10">
        <div className="mx-auto max-w-2xl text-center">
          <div className="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full bg-brand-50 text-brand-500 dark:bg-brand-500/10">
            <svg
              className="h-10 w-10"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <p className="mb-10 text-gray-500 dark:text-gray-400">
            ...
            issues you might face while using the restaurant management system.
          ...
          <a
            ...
            className="group inline-flex items-center justify-center gap-3 rounded-full bg-[#25D366] px-8 py-4 text-lg font-semibold text-white transition-all hover:bg-[#1DA851] hover:shadow-lg hover:-translate-y-1"
          >
            <svg
