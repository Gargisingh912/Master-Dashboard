...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Navigation */}
      <nav className="border-b border-gray-200 dark:border-gray-800 sticky top-0 bg-white/95 backdrop-blur-sm z-40">
        <div className="container-custom">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center space-x-2">
              <Store className="w-8 h-8 text-brand-500 hover:text-brand-600" />
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="#features"
                className="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:text-white/90 transition-colors"
              >
                Features
              </a>
              <a
            ...
            <button
              ...
              className="md:hidden text-gray-800 dark:text-white/90"
            >
              {mobileMenuOpen ? (
                <X className="w-6 h-6" />
              ) : (
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 space-y-3 border-t border-gray-200 dark:border-gray-800">
              <a
                href="#features"
                className="block py-2 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:text-white/90 transition-colors"
      ...
      <section className="py-20 md:py-32 overflow-hidden">
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 dark:text-white/90 mb-6 leading-tight">
            ...
            <div className="grid grid-cols-3 gap-8 mt-16 max-w-2xl mx-auto">
              <div>
                <div className="text-3xl font-bold text-gray-800 dark:text-white/90 mb-1">50+</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  Active Restaurants
                </div>
              </div>
              <div>
                <div className="text-3xl font-bold text-gray-800 dark:text-white/90 mb-1">10k+</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  Orders Processed
                </div>
              </div>
              <div>
                <div className="text-3xl font-bold text-gray-800 dark:text-white/90 mb-1">4.9</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  Customer Rating
                </div>
              </div>
      ...
      <section id="features" className="py-20 bg-white dark:bg-gray-800">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white/90 mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="rounded-xl border border-gray-200 bg-white p-6 dark:border-white/[0.05] dark:bg-white/[0.03] text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-brand-50 dark:bg-brand-500/10 mb-4">
                  <feature.icon className="w-8 h-8 text-brand-500 hover:text-brand-600" />
                </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400">
              Start with a 14-day free trial. No credit rounded-xl border border-gray-200 bg-white p-6 dark:border-white/[0.05] dark:bg-white/[0.03] required.
            </p>
          </div>
            ...
            {Object.entries(APP_CONFIG.plans).map(([key, plan]) => (
              <div
                ...
                className={`rounded-xl border border-gray-200 bg-white p-6 dark:border-white/[0.05] dark:bg-white/[0.03] ${
                  key === "starter" ? "ring-2 ring-brand-500 relative" : ""
                }`}
              >
                {key === "starter" && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-brand-500 text-white px-4 py-1 rounded-full text-sm font-medium">
                    Most Popular
                  </div>
                )}
      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="bg-brand-500 rounded-lg p-12 text-center text-white">
            ...
            <Link to="/register">
              <Button
                size="lg"
                variant="outline"
                className="bg-white text-brand-500 hover:text-brand-600 hover:bg-white/90"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <Store className="w-6 h-6 text-brand-500 hover:text-brand-600" />
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-white/90 mb-4">Product</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#features"
                    className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:text-white/90"
                  >
                    Features
                  </a>
                </li>
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-white/90 mb-4">Company</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-white/90 mb-4">Legal</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
