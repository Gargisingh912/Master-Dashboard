      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
          ...
          <div className="flex items-end justify-between mt-5">
            <div>
              <span className="text-sm text-gray-500 dark:text-gray-400">Inventory Alerts</span>
              {lowStockCount === 0 ? (
                <h4 className="mt-2 font-bold text-title-sm text-success-600 dark:text-success-400">
                  Inventory Stocked
                </h4>
              ) : (
                <h4 className="mt-2 flex items-center gap-1.5 font-bold text-title-sm text-red-600 dark:text-red-400">
                  ...
                  {lowStockCount.toLocaleString()} Low Stock
                </h4>
              )}
            </div>
          </div>
